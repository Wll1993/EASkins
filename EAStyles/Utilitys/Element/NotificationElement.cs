    ...
    public class NotificationElement : FrameworkElement
    {
        ...
        public class NotificationAreaIcon : FrameworkElement
        {
            ...
            public static readonly DependencyProperty FormsContextMenuProperty =
                DependencyProperty.Register("MenuItems", typeof(List<System.Windows.Forms.ToolStripItem>), typeof(NotificationAreaIcon), new PropertyMetadata(new List<System.Windows.Forms.ToolStripItem>()));
            ...
            protected override void OnInitialized(EventArgs e)
            {
                ...
                if (this.MenuItems != null && this.MenuItems.Count > 0)
                {
                    ...
                    notifyIcon.ContextMenuStrip.Items.AddRange(this.MenuItems.ToArray());
                }
            ...
            public List<System.Windows.Forms.ToolStripItem> MenuItems
            {
                get { return (List<System.Windows.Forms.ToolStripItem>)GetValue(FormsContextMenuProperty); }
